#ifndef 2v5p9a_default_data_h_
#define 2v5p9a_default_data_h_
...
template <typename F>
struct minus_data<2v5p9a,F> {
  typedef minus_core<2v5p9a> M;
  typedef minus_io<2v5p9a> io;
  typedef minus_io_14a<2v5p9a> io14;
  ...
  // XXX this problem has no tangents, remove!
