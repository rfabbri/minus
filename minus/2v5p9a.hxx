...
template <typename F> /// XXX No need for 9a formulation!
inline void 
minus_io<2v5p9a, F>::
...
//
template <typename F> // XXX implement
inline void 
minus_io<2v5p9a, F>::
...
template <typename F>
inline void 
minus_io<2v5p9a, F>:: // XXX implement
point2params(const F p[pp::nviews][pp::npoints][io::ncoords2d], C<F> * __restrict__ params/*[static 2*M::nparams]*/)
{
  // the user provides the start params in the first half of params.
  // we fill the second half and gammify both.
  F plines[pp::nvislines][io::ncoords2d_h];
  // XXX this is generating the visible lines for the points
  // but we should just have something like
  //
  // points2internal_representation XXX
  // 
...
inline void 
minus_io<2v5p9a, F>::
points2params_img(const F p[pp::nviews][pp::npoints][io::ncoords2d], const F K[/*3 or 2*/][io::ncoords2d_h], C<F> * __restrict__ params/*[static 2*M::nparams]*/)
{
  ...
  points2params(pn, params/*[static 2*M::nparams]*/);
}
...
{
  typedef minus_data<2v5p9a,F> data;
  ...
  io::point_tangents2params(p, tgt, id_tgt0, id_tgt1, params); // XXX
