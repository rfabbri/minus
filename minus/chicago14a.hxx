...
struct eval<chicago14a, F> {
  static void inline  __attribute__((always_inline)) Hxt(const C<F> * __restrict x /*x, t*/,    const C<F> * __restrict params, C<F> * __restrict y /*HxH*/);
...
lines2params(const F plines[pp::nvislines][io::ncoords2d_h], C<F> * __restrict params/*[static 2*M::nparams]*/)
{
  ...
  for (unsigned l=0; l < 6; ++l) {
    ...
    double l0l0 = 1/*vec::dot(l0,l0)*/, l0l1 = vec::dot(l0,l1), l1l1 = 1/*vec::dot(l1,l1)*/,
