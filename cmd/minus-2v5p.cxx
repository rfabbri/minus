...
#include <minus/2v5p9a-io.h>
#include <minus/2v5p-default.h>

using namespace MiNuS;
#define Float double
typedef minus_core<2v5p> M;
...
iread(const char *fname)
{
  ...
  if (!read_block(in, (F *)data::p_, io::pp::nviews*io::pp::npoints*io::ncoords2d))
    return false;
  LOG("reading tgt_"); // XXX no tangents for 2v5p! 
...
// Format is just like P01 variable in solve2v5p in 2v5p.m2
...
// Simplest possible command to compute the 2v5p problem
